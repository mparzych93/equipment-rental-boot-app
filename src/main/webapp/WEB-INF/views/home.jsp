    ...
    <div id="carouselExampleControls" class="carousel slide main-slider" data-ride="carousel">
        <div class="carousel-inner container">
            <div class="carousel-item active">
                <div class="container w-75 d-flex">
                    <div class="carousel-caption d-block">
                        <h1>Zarabiaj na wypozyczeniu, tego co jest Ci zbedne!</h1>
                        <h3>Masz dosc przekladania nieuzywanych rzeczy z kata w kat? Wypozycz to i zgarnij kase!</h3>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="container w-75 d-flex">
                    <div class="carousel-caption d-block">
                        <h1>Nagla sytuacja zmusza Cie do zakupu drogiego sprzetu?</h1>
                        <h3>Nie wydawaj majatku na wiertarke, ktora uzyjesz raz. Wypozycz ja, za duzo nizsze pieniadze!</h3>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <div class="container w-75 d-flex">
                    <div class="carousel-caption d-block">
                        <h1>Przeraza Cie jezdzenie po sklepach, poswiecenaie na to czasu?</h1>
                        <h3>Sprawdz, czy Twoj sasiad nie ma tego, czego potrzebujesz wlasnie teraz!</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container d-flex justify-content-between">
        ...
        <div class="ml-4 align-self-center">
            <button class="btn btn-color rounded-0 mt-4 pl-4 pr-4">
                <a href="/gate">Zaplanuj posilki</a>
            </button>
        </div>
    </div>
</section>
